...
Generated Autoplan Board verification evidence is written here when `npm run dashboard:verify` and browser smoke runs execute.

The runtime board state itself is intentionally gitignored under `.autoplan-board/`.
