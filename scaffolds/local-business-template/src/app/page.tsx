  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="bg-primary py-24 text-center text-primary-foreground">
        ...
        <a href="/contact" className="mt-8 inline-block rounded-lg bg-white px-8 py-3 font-semibold text-primary">Book Now / Get a Quote</a>
      </section>

      {/* About */}
      <section className="mx-auto max-w-4xl px-4 py-16">
        <h2 className="text-3xl font-bold">About Us</h2>
        <p className="mt-4 text-lg text-secondary">{{Replace with your business story, mission, and what makes you different.}}</p>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        ...
        <blockquote className="mt-8 rounded-xl bg-accent p-6">
          <p className="text-lg italic">"{{Customer testimonial}}"</p>
      ...
      <section className="bg-primary py-16 text-center text-primary-foreground">
        ...
        <a href="/contact" className="mt-8 inline-block rounded-lg bg-white px-8 py-3 font-semibold text-primary">Contact Us</a>
      </section>
