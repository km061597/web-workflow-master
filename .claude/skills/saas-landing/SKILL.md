...
- Read `DESIGN.md` — **TODO pending owner** (not yet bundled) in the current working directory. If missing, stop and ask for one.
...
See [`../../skills-protocol.md` — **TODO pending owner** (not yet bundled)](../../skills-protocol.md) for the full protocol.
