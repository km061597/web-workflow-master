...
> **Design system source of truth:** [`design-systems/kami/DESIGN.md` — **TODO pending owner** (not yet bundled)](../../design-systems/kami/DESIGN.md).
...
[`example.html` — **TODO pending owner** (not yet bundled)](./example.html) and use only the tokens from
`design-systems/kami/DESIGN.md` — **TODO pending owner**. Do **not** invent new colors,
...
- **Do not** use `rgba()` for tag fills — print renderers
  ...
  table in `design-systems/kami/DESIGN.md` — **TODO pending owner** — §2.
- **Do not** add JavaScript for animation. The page is paper, not
  an app — motion belongs to the reader scrolling.

## See also

- [`design-systems/kami/DESIGN.md` — **TODO pending owner** (not yet bundled)](../../design-systems/kami/DESIGN.md) — the full token spec.
- [`skills/kami-deck/` — **TODO pending owner** (not yet bundled)](../kami-deck/) — sister skill that produces a
